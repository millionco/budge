      ...
      <div className="page-content w-full flex flex-col items-center py-12">
        <div className="relative w-full max-w-112.75 min-w-0 px-4 sm:px-0">
          ...
          <div className="relative [font-synthesis:none] mt-5 w-full rounded-[12px] border border-solid border-[color(display-p3_0_0_0/0.1)] bg-[color(display-p3_0.991_0.991_0.991)] px-3.5 py-2.75 text-[13px]/[20px] font-medium text-[#707070] [box-shadow:#0000001A_0px_0px_0px_1px,#00000014_0px_1px_2px_-1px,#0000000F_0px_3px_8px_-3px] antialiased">
            <span className="font-semibold text-[#3F3F3F]">New:</span> budge now auto-detects local
            style changes and opens itself when your agent nudges spacing, type, radius, or size.
          </div>
        </div>
        ...
        <div className="relative w-full max-w-112.75 min-w-0 px-4 sm:px-0">
          ...
          <div className="[letter-spacing:0em] [white-space-collapse:preserve] font-medium text-[15px]/[22px] text-[#707070] mt-4">
            Install the skill and leave the script on the page. Ask your agent to make a visual
            change; on local dev, budge can detect the update and appear automatically.
          </div>
          <CodeBlock />
          ...
          <div className="[letter-spacing:0em] [white-space-collapse:preserve] font-medium text-[15px]/[22px] text-[#707070] mt-4">
            ...
            <code className="font-mono-override text-[#3F3F3F]">--spacing-md</code>,{" "}
            <code className="font-mono-override text-[#3F3F3F]">--radius-lg</code>, etc.), ↑↓ snaps
            through the scale and the copied prompt reads{" "}
            <code className="font-mono-override text-[#3F3F3F]">var(--spacing-md)</code> instead of
            raw pixels. Works with Tailwind v4&rsquo;s{" "}
            <code className="font-mono-override text-[#3F3F3F]">@theme</code>, Shadcn, or any{" "}
            <code className="font-mono-override text-[#3F3F3F]">:root</code> variables. Press{" "}
            <code className="font-mono-override text-[#3F3F3F]">T</code> to toggle.
          </div>
            ...
            <table className="w-full text-[13px]/[20px] font-mono">
              ...
              <tbody className="text-[#3F3F3F]">
                <tr className="border-b border-[color(display-p3_0_0_0/0.04)]">
                  ...
                  <td className="px-3 py-2 text-[#999]">string</td>
                  <td className="px-3 py-2">Display name shown above bar</td>
                </tr>
                <tr className="border-b border-[color(display-p3_0_0_0/0.04)]">
                  <td className="px-3 py-2">property</td>
                  <td className="px-3 py-2 text-[#999]">string</td>
                  <td className="px-3 py-2">CSS property to apply</td>
                </tr>
                <tr className="border-b border-[color(display-p3_0_0_0/0.04)]">
                  <td className="px-3 py-2">min</td>
                  <td className="px-3 py-2 text-[#999]">number</td>
                  <td className="px-3 py-2">Minimum numeric value</td>
                </tr>
                <tr className="border-b border-[color(display-p3_0_0_0/0.04)]">
                  <td className="px-3 py-2">max</td>
                  <td className="px-3 py-2 text-[#999]">number</td>
                  <td className="px-3 py-2">Maximum numeric value</td>
                </tr>
                <tr className="border-b border-[color(display-p3_0_0_0/0.04)]">
                ...
                <tr className="border-b border-[color(display-p3_0_0_0/0.04)]">
                  ...
                  <td className="px-3 py-2 text-[#999]">number</td>
                  <td className="px-3 py-2">Value before the change</td>
                </tr>
                <tr className="border-b border-[color(display-p3_0_0_0/0.04)]">
                ...
                <tr className="border-b border-[color(display-p3_0_0_0/0.04)]">
                  ...
                  <td className="px-3 py-2 text-[#999]">{'"color"?'}</td>
                  <td className="px-3 py-2">Only set for color properties</td>
                </tr>
                <tr className="border-b border-[color(display-p3_0_0_0/0.04)]">
                  <td className="px-3 py-2">scale</td>
                  <td className="px-3 py-2 text-[#999]">
                    {'"spacing" | "radius" | "text" | "color" | null?'}
                  </td>
                  <td className="px-3 py-2">Override auto-detected token scale</td>
                </tr>
                <tr>
                  <td className="px-3 py-2">tokens</td>
                  <td className="px-3 py-2 text-[#999]">BudgeToken[]?</td>
                  <td className="px-3 py-2">Explicit tokens (overrides CSS-var discovery)</td>
                </tr>
              </tbody>
            </table>
          </div>
