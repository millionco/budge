...
`);
  ...
  function c_(e) {
    return e.scale === void 0 ? a_(e.property) : e.scale;
  }
  function l_(e) {
...
`)
  ...
  function V_({ autoFocus: e, slides: t } = {}) {
    let n = t && t.length > 0 ? t : S_,
      r = (0, w.useRef)(n);
    r.current = n;
    ...
    ((0, w.useEffect)(() => {
      ...
      (0, w.useEffect)(() => {
        ...
        if (!t) return;
        let r = c_(t),
          i = O && r && r !== `color` ? u_(t, D.current) : null,
          a = i ? d_(i, s) : null,
          o = a
            ? a.value
            : t.type === `color`
        ...
        for (let n of l_(t.property)) e.style.setProperty(n, o);
      }, [s, ye, n]));
    ...
    let De = (0, w.useCallback)(
        (e, t = !1, r = !1) => {
          let i = n[xe.current],
            a = c_(i),
            s = ue.current && a && a !== `color` ? u_(i, D.current) : null,
            l = E.current,
            u;
          if (s) {
            let n = h_(s, E.current, e, t),
              r = s.length;
            u = s[((n % r) + r) % r].numeric ?? E.current;
          } else {
            let n = o.shiftStep && t ? 10 : 1;
            u = g_(E.current + e * n, i.min, i.max);
          }
          ((E.current = u),
            c(E.current),
            Ce && (u !== l && (e > 0 ? u < l : u > l) ? R_() : P_(r, e > 0)));
        },
        [o.shiftStep, i, Ce],
      ),
      Oe = (0, w.useCallback)(
      ...
      je = (0, w.useCallback)(() => {
        ...
        let e = n.map((e, t) => {
            ...
            return {
              property: e.property,
              value: f_(e, n, ue.current, D.current),
              location: p_(e),
              changed: __(e, n),
            };
          }),
...
`)
      ...
      (0, w.useEffect)(() => {
        ...
        function e(e) {
          ...
          if (t && e.key === `Backspace`) {
            ...
            if (!n) return;
            (isNaN(t) ||
              (u(ae.current), m(!0), P_(), t >= n.min && t <= n.max && ((E.current = t), c(t))),
              clearTimeout(oe.current),
              clearTimeout(T.current),
    ...
    let qe = l === null ? `${s}` : l,
      ...
      Xe = c_(Se),
      Ze = O && Xe && Xe !== `color` ? u_(Se, D.current) : null,
      Qe = Ze ? d_(Ze, s) : null,
      $e = Se.type === `color`,
      et = `hsl(${s}, 70%, 55%)`,
  ...
  let H_ = typeof document < `u` ? document.currentScript : null;
  (() => {
    if (typeof document > `u`) return ``;
    let e = H_?.getAttribute(`src`);
    if (!e) return ``;
    try {
  ...
  let U_ = h({ name: `budge-widget`, mount: te(V_), isolation: `none` }),
    W_ = `data-budge-autodetect`,
    G_ = `data-budge-target`,
    K_ = `[data-budge-ui]`,
    q_ = `[data-budge]`,
    J_ = [
      `[data-react-grab]`,
  ...
  function hv() {
    let e = fv(),
      ...
      i = n ? Z_ : t;
    (pv(r) && !U_.mounted
      ? U_.mount(document.body, { slides: r.slides, autoFocus: r.autoFocus ?? !0 })
      : pv(r) && U_.mounted && i !== Y_
        ? U_.update({ slides: r.slides, autoFocus: r.autoFocus ?? !0 })
        : !pv(r) && U_.mounted && U_.unmount(),
      (Y_ = i));
  }
  function gv() {
  ...
  function _v() {
    let e =
      H_?.getAttribute(W_) ??
      H_?.getAttribute(`data-budge-auto`) ??
      document.documentElement.getAttribute(W_);
  ...
  function xv(e) {
    return e instanceof Element && !!e.closest(K_);
  }
  function Sv(e) {
    xv(e.target) || (dv = performance.now());
  }
  function Cv() {
    return performance.now() - dv < 1200;
  }
  function wv() {
    (cv?.remove(), (cv = null));
  }
  ...
  function Ov(e) {
    let t = getComputedStyle(e),
      n = {};
    for (let e of vv) n[e] = t.getPropertyValue(e);
    return n;
  }
  function kv(e) {
    let t = e.trim();
  ...
  function Mv(e, t) {
    ...
    for (let r of vv) {
      ...
      let i = kv(e[r]),
        a = kv(t[r]);
      !i || !a || (jv(i, a) && n.push({ property: r, before: i, after: a }));
    }
    return n;
  }
  function Nv(e) {
  ...
  function Lv(e) {
    ...
    for (let e of n) {
      ...
      if (!(n.length !== e.properties.length || !Iv(n)))
  ...
  function zv(e, t) {
    let n = e.property,
      r = [Rv(n, n.replace(/,/g, ` + `), e.before, e.after)],
      i = new Set([n]);
    for (let e of Nv(n)) {
      if (i.has(e)) continue;
      let n = kv(t[e]);
  ...
  function Vv(e, t) {
    let n = t.map((t) => kv(e[t]));
    if (n.some((e) => !e)) return null;
    let r = n[0];
    return n.every((e) => e && Bv(r, e)) ? r : null;
  }
  function Hv(e, t) {
    return kv(e[t]);
  }
  ...
  function Wv(e) {
    let t = Ov(e),
      ...
      r = new Set(),
      i = (e, t, i) => {
        !i || r.has(e) || n.length >= 40 || (n.push(Rv(e, t, i, i)), r.add(e));
      },
      a = (e, i) => {
      ...
      o = (e, n, r, a, o) => {
        ...
        (i(`${n}-top,${n}-bottom`, `${e}-y`, c),
          ...
          i(`${n}-top`, `${e} top`, Hv(t, a[0])),
          i(`${n}-bottom`, `${e} bottom`, Hv(t, a[1])),
          i(`${n}-left`, `${e} left`, Hv(t, o[0])),
          i(`${n}-right`, `${e} right`, Hv(t, o[1])));
      };
    (o(
      `padding`,
      `padding`,
    ...
    return (
      ...
      i(`font-size`, `font size`, Hv(t, `font-size`)),
      i(`line-height`, `line height`, Uv(t, `line-height`)),
      i(`letter-spacing`, `letter spacing`, Uv(t, `letter-spacing`)),
      a(`color`, `text color`),
      ...
      i(`border-top-left-radius`, `top left radius`, Hv(t, `border-top-left-radius`)),
      i(`border-top-right-radius`, `top right radius`, Hv(t, `border-top-right-radius`)),
      i(`border-bottom-right-radius`, `bottom right radius`, Hv(t, `border-bottom-right-radius`)),
      i(`border-bottom-left-radius`, `bottom left radius`, Hv(t, `border-bottom-left-radius`)),
      i(`border-width`, `border width`, Hv(t, `border-width`)),
      i(`width`, `width`, Hv(t, `width`)),
      i(`height`, `height`, Hv(t, `height`)),
      i(`max-width`, `max width`, Hv(t, `max-width`)),
      i(`max-height`, `max height`, Hv(t, `max-height`)),
      i(`opacity`, `opacity`, Hv(t, `opacity`)),
      n
    );
  }
  function Gv(e) {
    ($_ && $_ !== e && !ev && $_.removeAttribute(G_),
      ($_ = e),
      (ev = e.hasAttribute(G_)),
      ev || e.setAttribute(G_, ``));
  }
  function Kv(e, t, n = `detect`) {
    (Gv(e), (Q_ = n), (X_ = { slides: t, autoFocus: !0 }), (Z_ = mv(X_)), hv(), Yv(e, Z_));
  }
  function qv(e) {
    return (
  ...
  async function Yv(e, t) {
    if (X_?.slides && !(t !== Z_ || $_ !== e))
      try {
        let n = await Pa(e),
          r = qv(n),
          i = Jv(n);
        if (t !== Z_ || $_ !== e || !X_?.slides) return;
        ((X_ = {
          ...X_,
          slides: X_.slides.map((e) => ({
            ...e,
            file: r?.fileName ?? e.file,
            line: r?.lineNumber ?? e.line,
            elementContext: i ?? e.elementContext,
          })),
        }),
          (Z_ = mv(X_)),
          hv());
  ...
  function Qv(e, t) {
    let n = Zv(() => document.elementFromPoint(e, t));
    return !(n instanceof HTMLElement) || bv(n) ? null : n;
  }
  function $v(e, t) {
    return Zv(() => document.elementsFromPoint(e, t)).filter(
      (e) => e instanceof HTMLElement && !bv(e),
    );
  }
  function ey(e) {
    let t = [],
    ...
    for (; n && n !== document.documentElement && n !== document.body; )
      (bv(n) || t.push(n), (n = n.parentElement));
    return t;
  }
  function ty(e) {
    for (let t of e.querySelectorAll(`*`)) if (t instanceof HTMLElement && !bv(t)) return t;
    return null;
  }
  function ny(e) {
    if (!e) return null;
  ...
  function ay() {
    ((lv = !1), uv !== null && (window.clearTimeout(uv), (uv = null)));
  }
  function oy() {
    ((lv = !0), uv !== null && window.clearTimeout(uv), (uv = window.setTimeout(ay, 600)));
  }
  function sy(e) {
    (e.preventDefault(), e.stopImmediatePropagation());
  }
  ...
  function ly() {
    ((nv = !1), (iv = null), (av = []), (ov = 0), (sv = null), wv(), iy());
  }
  function uy(e, t) {
    nv && ((sv = { x: e, y: t }), (av = ey(Qv(e, t))), (ov = 0), (iv = av[ov] ?? null), Ev(iv));
  }
  function dy(e) {
    if (!nv || av.length === 0) return;
    let t = Math.max(0, Math.min(av.length - 1, ov + e));
    if (t === ov) {
      if (e >= 0) return;
      let t = ny(iv);
      if (!t) return;
      ((av = ey(t)), (ov = 0), (iv = av[ov] ?? t), Ev(iv));
      return;
    }
    ((ov = t), (iv = av[ov] ?? null), Ev(iv));
  }
  function fy(e) {
    let t = [];
    try {
  ...
  function py() {
    tv ||
      ...
      window.addEventListener(
        `keydown`,
        (e) => {
          if ((Sv(e), nv && (e.key === `ArrowUp` || e.key === `ArrowDown`))) {
            (e.preventDefault(), e.stopPropagation(), dy(e.key === `ArrowUp` ? 1 : -1));
            return;
          }
          if (!Xv(e)) {
            nv && e.key === `Escape` && (e.preventDefault(), e.stopPropagation(), ly());
            return;
          }
          (e.preventDefault(), e.stopPropagation(), cy());
        },
        { capture: !0 },
      ),
      window.addEventListener(`blur`, ly),
      window.addEventListener(`pointerdown`, Sv, { capture: !0, passive: !0 }),
      window.addEventListener(
        `pointermove`,
        (e) => {
          uy(e.clientX, e.clientY);
        },
        { capture: !0, passive: !0 },
      ),
      window.addEventListener(
        ...
        (e) => {
          !nv ||
            e.button !== 0 ||
            !e.isPrimary ||
            (oy(), sy(e), fy(iv ?? Qv(e.clientX, e.clientY)));
        },
        { capture: !0 },
      ),
      window.addEventListener(
      ...
      window.addEventListener(
        ...
        (e) => {
          (!nv && !lv) ||
            (sy(e),
            nv && fy(e instanceof MouseEvent ? (iv ?? Qv(e.clientX, e.clientY)) : iv),
            ay());
        },
        { capture: !0 },
      ));
  ...
  function my(e) {
    ...
    for (let e of t) bv(e) || yv.set(e, Ov(e));
  }
  function hy() {
    if (!_v() || !document.body) return;
    my(document.body);
    let e = null,
      t,
      n = (n, r) => {
        ((e = { el: n, slides: r }),
          clearTimeout(t),
          (t = setTimeout(() => {
            e &&= (Kv(e.el, e.slides), null);
          }, 80)));
      };
    new MutationObserver((e) => {
      if (!document.querySelector(q_))
        for (let t of e) {
          if (t.type === `childList`) {
            for (let e of t.addedNodes) e instanceof Element && my(e);
            continue;
          }
  ...
  if (typeof document < `u`) {
    let e = () => {
      (hv(),
        hy(),
        py(),
        new MutationObserver(hv).observe(document.documentElement, {
          childList: !0,
          subtree: !0,
          attributes: !0,
